...
//    Vấn đề: Mặc định, một Access Token của OAuth2 rất đơn điệu.
//    Nó thường chỉ có mã token, thời gian hết hạn và loại token (Bearer).
//    Giải pháp: TokenEnhancer cho phép bạn "nhồi" thêm các thông tin
//      tùy chỉnh (Custom Information) vào bên trong token đó
    @Override
