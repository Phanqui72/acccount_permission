...
public class ResourceServerConfig extends ResourceServerConfigurerAdapter {
    ...
    public void configure(HttpSecurity http) throws Exception {
        http.addFilterAfter(jsonFilter, BasicAuthenticationFilter.class)
                ...
                .antMatchers("/v1/account/request-forget-password", "/v1/account/forget-password","/v1/account/verify-credential", "/api/auth/login-internal").permitAll()
    ...
    public void configure(ResourceServerSecurityConfigurer resources) throws Exception {
        resources.resourceId("sell-mgr-service");
    }
}